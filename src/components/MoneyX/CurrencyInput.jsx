      ...
      <div className="relative bg-[#0d0d0d] dark:bg-gray-50 rounded-xl p-4 focus-within:ring-2 focus-within:ring-emerald-500 dark:focus-within:ring-emerald-400 transition-all duration-200 border border-[#2a2a2a] dark:border-gray-300">
        <div className="flex items-center justify-between gap-4">
          ...
          <input
            ...
            placeholder="0.00"
            readOnly={readOnly}
            className="flex-1 bg-transparent text-white dark:text-gray-900 text-3xl font-semibold outline-none placeholder:text-gray-600 dark:placeholder:text-gray-400"
          />

          {/* Currency Badge */}
          {!hideLabel && (
            <div className="px-3 py-1.5 bg-[#1a1a1a] dark:bg-gray-200 rounded-lg text-gray-400 dark:text-gray-700 text-sm font-medium">
              {currency}
            </div>
          )}
        </div>
